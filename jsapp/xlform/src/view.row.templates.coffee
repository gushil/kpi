      ...
      <div class="survey__row__item survey__row__item--question card js-select-row">
        <div class="card__header">
          ...
          <div class="card__text">
            <input type="text" placeholder="#{_t("Item label is required")}" class="card__header-title js-card-label js-cancel-select-row js-cancel-sort">
  ...
  groupView = ()->
    ...
    <div class="survey__row__item survey__row__item--group group card js-select-row">
      <header class="group__header">
        ...
        <input type="text" placeholder="" class="card__header-title js-card-label  js-cancel-select-row js-cancel-sort">
